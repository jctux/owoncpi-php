...
class Logger
{
     ...
     *
     * @param
     *            String logfile - [optional] Absolute file name/path. Defaults to ubuntu apache log.
     * @return void
     *
     */
    function __construct($log_file = "/var/tmp/php/logger.log", $mode = null)
    {
        if ($mode != null)
            $this->mode = $mode;
     ...
     *            String tag - Log Tag
     * @param
     *            String message - message to spit out
     * @return void
     *
     */
     ...
     *
     * @param
     *            String status - "INFO"/"DEBUG"/"ERROR" e.t.c.
     * @param
     *            String tag - "Small tag to help find log entries"
     * @param
     *            String message - The message you want to output.
     * @return void
     *
     */
